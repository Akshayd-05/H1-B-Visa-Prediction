...
background_image = "https://github.com/Akshayd-05/H1-B-Visa-Prediction/blob/main/H1B.png" 
...
st.image("https://github.com/Akshayd-05/H1-B-Visa-Prediction/blob/main/H1B.png", use_column_width=True)
...
def load_model(url):
    ...
    model_file = BytesIO(response.content)  # Load the file content as a byte stream
    return pickle.load(model_file)  # Unpickle the model
...
html_temp1 = """
    ...
    <p style="color:white;text-align:center;">Designed & Developed By: <b>Akshay Damodar Prabhu</b></p>
    </div>
    """
