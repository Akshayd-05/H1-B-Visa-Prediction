...
st.image("https://github.com/Akshayd-05/H1-B-Visa-Prediction/blob/main/H1B.png", use_container_width=True)
...
model_url = 'https://raw.githubusercontent.com/Akshayd-05/H1-B-Visa-Prediction/main/Final_Project.pkl'
